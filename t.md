...
#  درباره‌ی پایتون
پایتون یکی از ان زبان‌های برنامه نویسی است, که می تواند ادعای  قدرتمندی و سادگی را, همزمان بکند.
...
من در مورد این ویژگی‌ها بیشتر بحث خواهم کرد , در بخش‌های بعدی .
...
**GNU/Linux, Windows, FreeBSD, Macintosh, Solaris, OS/2, Amiga, AROS, AS/400, BeOS, OS/390, z/OS, Palm OS, QNX, VMS, Psion, Acorn RISC OS, VxWorks, PlayStation, Sharp Zaurus, Windows CE and PocketPC!
**
<div dir=rtl>
