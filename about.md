...
اولین پیش‌نویش از این کتاب من در ردهت 9.0 در لینوکس  بود و به عنوان شیشمین  من با استفاده از لینوکس فدورای ۳ هسته‌ی برای پیش‌نویس‌هایم استفاده کردم. 

اولین بار برای نوشتن کتاب من از KWord استفاده می‌کردم.که  در [history lesson](./revision_history.md#history-lesson) توضیح دادم.
