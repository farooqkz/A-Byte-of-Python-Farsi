...
ا
از انجا که بحث ما در مورد قالب بندی است. توجه داشته باشید که `print` همیشه با یک کاراکتر نامرئی( (`\n`)  " (خط جدید) new line"  ) جمله را به پایان می‌رساند. به طوری که صدا زدن مکرر `print` همه را در یک خط جداگانه `چاپ` می‌کند. برای جلوگیری از کاراکتر newline (خط جدید) در چاپ ، شما می‌توانید با مشخصه`end` از این کار جلو گیری کنید.
